          ...
          <div class="container-fluid" style="padding: 11px;">
              <div class="row name-border" style="background-color: rgb(50, 53, 46, 0.5); border-color: rgb(100, 112, 84);">
                  <div class="col-lg-2 order-lg-1 order-2">
                      <ul class="image_list">
                          <li data-image="Pictures\Knife2-2.jpg"><img src="Pictures\Knife1-2.jpg" alt=""></li>
                          <li data-image="Pictures\Knife2-3.jpg"><img src="Pictures\Knife1-3.jpg" alt=""></li>
                          <li data-image="Pictures\Knife2-4.jpg"><img src="Pictures\Knife1-4.jfif" alt=""></li>
                      </ul>
                  </div>
                  <div class="col-lg-4 order-lg-2 order-1">
                      <div class="image_selected"><img src="Pictures\Knife1.jpg" alt=""></div>
                  </div>
                      ...
                      <div class="product_description">
                          <nav>
                              <ol class="breadcrumb">
                                  ...
                                  <li class="breadcrumb-item"><a href="BigKnives.php">Big Knives</a></li>
                                  <li class="breadcrumb-item active">Sony Headphone</li>
                                  <span class="wish-icon" style="margin-left: 3rem; font-size: 28px;"><i class="fa fa-heart-o" id="heart"></i></span>
                              </ol>
                          </nav>
                          <div class="product_name">Sony Headphone</div>
                          <div class="product-rating"><span class="badge badge-success"><i class="fa fa-star"></i> 4.7 Star</span></div>
                          <div> <span class="product_price">$23.99</span> </div>
