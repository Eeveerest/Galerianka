...
$stmt = $pdo->query('SELECT id, name, price FROM `products` order by id desc limit 8;');
...
$html = '';
  ...
  echo '<div id="NewestCarousel" class="carousel slide carousel1" data-bs-ride="NewestCarousel">';
  ...
  foreach ($stmt as $row){
    ...
    if ($list >= 5){
     ...
     echo '</div>' ;        
     echo '<a class="carousel-control-prev bg-transparent w-aut" href="#NewestCarousel" role="button" data-bs-slide="prev">';
     echo '<span class="carousel-control-prev-icon prev-icon1" aria-hidden="true"></span></a>';         
     echo '<a class="carousel-control-next bg-transparent w-aut" href="#NewestCarousel" role="button" data-bs-slide="next">';
