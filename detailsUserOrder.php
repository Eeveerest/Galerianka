...
<head>
  ...
  <script type="text/javascript" src="UserOrdersdetails.js"></script>
      ...
      <div class="container-fluid">
        <div class="collapse navbar-collapse" id="navbarSupportedContent2">
          <ul class="navbar-nav ms-auto">
            <li class="nav-item">
              <a class="nav-link active link-border category-link" aria-current="page" href="UserOrders.php">Back</a>
            </li>
          </ul>
      </div>
     </div>
