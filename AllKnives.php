...
<head>
  ...
  <script src="https://kit.fontawesome.com/06d4f426f5.js" crossorigin="anonymous"></script>
  
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/css/bootstrap.min.css" rel="stylesheet"
    integrity="sha384-rbsA2VBKQhggwzxH7pPCaAqO46MgnOM80zW1RWuH61DGLwZJEdK2Kadq2F9CUG65" crossorigin="anonymous">
  <link href="custom.css" rel="stylesheet">
  <script type="text/javascript" src="ProductAll.js"></script>
    ...
    <section class="section-products">
      <div class="container">
        ...
        <nav class="navbar navbar-expand black-border">
          <div class="container-fluid">
            <div class="collapse navbar-collapse" id="navbarSupportedContent2">
              <a class="navbar-brand brand1"><b>Knives</b></a>
              <ul class="navbar-nav ms-auto">
                ...
                <form action="" method="post" id="searchform" class="d-flex">
                  ...
                  <select class="nav-item dropdown link-border cat-dropdown nav-link active dropdown-toggle filter-dropdown" id="product_categ">                  
                    <option class="select-item" id="cat_none" value="none">Categories</option>
                    <?php 
  $stmt = $pdo->query('SELECT name FROM categories');
  foreach ($stmt as $row){
    echo '<option class="select-item"" id="'.$row['name'].'" value="'.$row['name'].'">'.$row['name'].'</option>';
  }
