...
$stmt = $pdo->query('SELECT id, name, price FROM `products` inner JOIN products_categories on products.id = products_categories.product_id WHERE products_categories.category_id = 2;');
