...
<head>
  ...
  <script type="text/javascript" src="AdminDeliveryJS.js"></script>
      ...
      <div class="container-fluid">
        <div class="collapse navbar-collapse" id="navbarSupportedContent2">
          <ul class="navbar-nav ms-auto">
            <li class="nav-item">
              <a class="nav-link active link-border category-link" aria-current="page" data-bs-toggle="modal" data-bs-target="#deliveryModal">Add delivery</a>
            </li>
            <li class="nav-item">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title" id="deliveryModalLabel">Add delivery</h3>
      </div>
      ...
      <div class="form-group">
       ...
       <div class="form-group">
            ...
            <input type="tel" class="form-control" name="InputPhone" id="InputPhone" pattern="[0-9]{9}" required value="">
...
<script>
    ...
    {
        iden = btn.id;
        text = "Are you sure you want to delete delivery with id  "+iden+"?";
        document.getElementById("bookdel").innerHTML = text;
    }

    function Del()
        {
            let base = "delAdminDelivery.php?id=";
  ...
  function IdEdit(btn){
    document.getElementById('DelivId').value = btn.id;
